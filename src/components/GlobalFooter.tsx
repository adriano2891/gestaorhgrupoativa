export const GlobalFooter = () => {
  return (
    <footer
      ...
      role="contentinfo"
    >
      <p className="text-sm sm:text-base text-primary-foreground/90" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
        © {new Date().getFullYear()} Grupo Ativa Tec • Todos os direitos reservados
      </p>
      <p className="text-xs sm:text-sm text-primary-foreground/60 mt-0.5 leading-tight max-w-3xl mx-auto px-4" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
