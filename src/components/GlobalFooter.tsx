export const GlobalFooter = () => {
  return (
    <footer
      ...
      role="contentinfo"
    >
      <p className="text-[11px] sm:text-xs text-primary-foreground/90 leading-tight" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
        © {new Date().getFullYear()} Grupo Ativa Tec • Todos os direitos reservados
      </p>
      <p className="text-[9px] sm:text-[10px] text-primary-foreground/60 leading-tight mt-0.5 max-w-full" style={{ fontFamily: 'Arial, Helvetica, sans-serif' }}>
