...
import { useUpdateCategoria } from "@/hooks/useDocumentos";
...
export const EditarCategoriaDialog = ({ open, onOpenChange, categoria, categorias }: EditarCategoriaDialogProps) => {
  const updateCategoria = useUpdateCategoria();

  const form = useForm<FormData>({
    resolver: zodResolver(formSchema) as any,
    defaultValues: {
      nome: "", descricao: "", cor: "#3B82F6", categoria_pai_id: undefined,
    },
  });
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField control={form.control} name="nome" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Input placeholder="Ex: Contratos" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
            <FormField control={form.control} name="descricao" render={({ field }) => (
              <FormItem>
                ...
                <FormControl><Textarea placeholder="Descreva a categoria..." className="resize-none" {...field} /></FormControl>
                <FormMessage />
              </FormItem>
            )} />
