    ...
    <div className="min-h-screen relative">
      ...
      <div className="min-h-screen relative">
              ...
              <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
                <SheetTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 md:hidden focus-ring"
                ...
                <SheetContent side="right" className="w-[280px] p-0">
                  <div className="flex flex-col h-full">
                    ...
                    <nav className="flex-1 p-4" aria-label="Menu principal mobile">
                        ...
                        {navItems.map((item) => {
                          ...
                          return (
                            <Link
                              ...
                              className={`flex items-center gap-3 px-3 py-3 rounded-lg text-sm font-medium transition-colors touch-target focus-ring ${
                                isActive
        ...
        {RH_PATHS.has(location.pathname) ? (
          ...
          <>
            <nav
              className="bg-primary border-b border-primary-foreground/10 fixed top-[44px] sm:top-[48px] md:top-[56px] left-0 right-0 z-40 hidden md:block"
              role="navigation"
                    ...
                    return (
                      <li key={item.path} style={{ flexShrink: 0 }}>
                        <Link
                          ...
                          className={`inline-flex items-center gap-1.5 px-3 py-3 text-xs lg:text-sm font-medium transition-all border-b-2 focus-ring ${
                            isActive
                        ...
                        >
                          <span className="text-base lg:text-lg" aria-hidden="true">{item.icon}</span>
                          <span>{item.label}</span>
                        </Link>
                      </li>
                    );
