...
const GestaoRH = () => {
  ...
  const allRhModules: ModuleItem[] = [
    ...
    { title: "Formulários", description: "Documentos e formulários RH", iconSrc: iconFormularios, path: "/formularios-rh", iconScale: "scale-[1.4]" },
    ...
    { title: "Documentações RH", description: "Gestão de documentos RH", iconSrc: iconDocumentos, path: "/documentacoes", iconScale: "scale-[1.4]" },
