  ...
  return (
    ...
    <div className="space-y-4 sm:space-y-6" style={{ fontFamily: 'Arial, sans-serif' }}>
              ...
              <TableBody>
                {filteredEmployees.map((employee) => (
                  <TableRow key={employee.id}>
                    <TableCell className="text-[10px] sm:text-xs font-semibold whitespace-nowrap" style={{ fontFamily: 'Arial, Helvetica, sans-serif', color: '#000000' }}>
                      {employee.matricula || '-'}
                    </TableCell>
                    <TableCell>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-[95vw] sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px] max-h-[85vh] overflow-hidden flex flex-col" style={{ fontFamily: 'Arial, sans-serif' }}>
