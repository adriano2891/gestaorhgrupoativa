  ...
  return (
    <div className="min-h-screen bg-background">
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {/* Simple title with actions - no RH header/icon bar */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-foreground">Documentações</h1>
                <p className="text-xs text-muted-foreground">Gestão de documentos — Sistema Integrado</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" onClick={() => setShowCategoriaDialog(true)} className="text-xs sm:text-sm">
              <FolderOpen className="w-4 h-4 mr-1.5" />
              <span className="hidden sm:inline">Nova Categoria</span>
            </Button>
            <Button size="sm" onClick={() => setShowUploadDialog(true)} className="text-xs sm:text-sm">
...
export default DocumentacoesSistema;
